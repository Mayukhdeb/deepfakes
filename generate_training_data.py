...
trim_video(source_path = "data/videos/obama.mp4", start_time = 60 + 52, end_time = 930, target_path = "data/videos/obama_trimmed.mp4")
trim_video(source_path = "data/videos/elon.mp4", start_time = 10, end_time =830, target_path = "data/videos/elon_trimmed.mp4")
